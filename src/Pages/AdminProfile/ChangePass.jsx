        ...
        <div className="w-full">
          ...
          <div className="relative w-full">
            <input
              ...
              name="password"
              placeholder="**********"
              className="w-full px-5 py-3 bg-white border-2 rounded-md border-whiteplaceholder:text-xl"
              required
            />
            <button
              type="button"
        ...
        <div className="w-full">
          ...
          <div className="relative w-full">
            <input
              ...
              name="password"
              placeholder="**********"
              className="w-full px-5 py-3 mt-5 bg-white border-2 border-white rounded-md outline-none placeholder:text-xl"
              required
            />
            <button
              type="button"
