...
const ForgatePassword = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-black">
            <div  className="py-10 md:py-28 mx-2 md:mx-0 px-6 md:px-10 rounded-2xl w-[580px] h-[525px] bg-white border-2 border-[#eef6ff] mt-10">
                ...
                >
                    ...
                    <Form.Item>
                       ...
                       <button
                            type="submit"
                            className=" bg-[#5F9E19] text-white py-3 px-20 rounded-lg"
                            disabled={loading}
                        >
