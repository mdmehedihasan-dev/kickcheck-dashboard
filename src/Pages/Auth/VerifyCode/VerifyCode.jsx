...
const VerifyCode = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black">
      <div className="py-10 md:py-28 mx-2 md:mx-0 px-6 md:px-10 rounded-2xl w-[580px] h-[525px] bg-white border-2 border-[#eef6ff] ">
        <div className="text-center">
          ...
          <form onSubmit={handleVerify} className="mt-6">
            ...
            <button
              type="submit"
              className=" py-3 px-20 mt-8 text-white transition-colors rounded-md bg-[#5F9E19] hover:bg-[#344e16e6] focus:outline-none focus:ring-2 focus:ring-sky-300 focus:ring-offset-2"
            >
              Verify Code
            </button>
          </form>
